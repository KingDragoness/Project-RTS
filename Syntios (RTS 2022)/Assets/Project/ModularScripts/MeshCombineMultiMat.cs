...
namespace ProtoRTS
{
	public static class MeshCombineMultiMat
	{

        public static GameObject MeshCombineFromMeshes(MeshFilter[] meshFilters, bool destroyObjects = false, params GameObject[] ignore)
        {
