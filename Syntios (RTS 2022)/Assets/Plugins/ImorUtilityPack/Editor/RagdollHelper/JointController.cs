...
namespace BzKovSoft.RagdollHelper.Editor
{
	...
	public static class JointController
	{
		...
		static float ProcessLimit(Vector3 position, Vector3 planeNormal, Vector3 startDir, float size, float limit)
		{
			...
			var fmh_211_65_638666986748875192 = Quaternion.identity; var fmh_211_122_638667337912423158 = Quaternion.identity; bool positionChanged = Handles.FreeMoveHandle(controllerPos, size * 0.1f, Vector3.zero, Handles.SphereHandleCap) != controllerPos;
			if (positionChanged)
			{
